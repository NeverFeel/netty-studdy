...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return People.internal_static_com_ilidan_grpc_BiRequest_descriptor;
  }

  @Override
  protected FieldAccessorTable
      internalGetFieldAccessorTable() {
    return People.internal_static_com_ilidan_grpc_BiRequest_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            BiRequest.class, Builder.class);
  }
  ...
  public boolean equals(final Object obj) {
    ...
    if (!(obj instanceof BiRequest)) {
      return super.equals(obj);
    }
    BiRequest other = (BiRequest) obj;
  ...
  public static BiRequest parseFrom(
  ...
  public static BiRequest parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static BiRequest parseFrom(
  ...
  public static BiRequest parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static BiRequest parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static BiRequest parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(BiRequest prototype) {
  ...
  public static final class Builder extends
    ...
    @Override
    public BiRequest getDefaultInstanceForType() {
      return BiRequest.getDefaultInstance();
    }

    @Override
    public BiRequest build() {
      BiRequest result = buildPartial();
    ...
    @Override
    public BiRequest buildPartial() {
      BiRequest result = new BiRequest(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof BiRequest) {
        return mergeFrom((BiRequest)other);
      } else {
    ...
    public Builder mergeFrom(BiRequest other) {
      if (other == BiRequest.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      BiRequest parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (BiRequest) e.getUnfinishedMessage();
  ...
  private static final BiRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new BiRequest();
  }

  public static BiRequest getDefaultInstance() {
