...
/**
 * Protobuf type {@code com.ilidan.grpc.PeopleList}
 */
public  final class PeopleList extends
    com.google.protobuf.GeneratedMessageV3 implements
    // @@protoc_insertion_point(message_implements:com.ilidan.grpc.PeopleList)
    PeopleListOrBuilder {
private static final long serialVersionUID = 0L;
  ...
  private PeopleList(
    ...
    try {
      ...
      if (((mutable_bitField0_ & 0x00000001) == 0x00000001)) {
        peopleStreamResponse_ = java.util.Collections.unmodifiableList(peopleStreamResponse_);
      }
   ...
   * <code>repeated .com.ilidan.grpc.PeopleStreamResponse peopleStreamResponse = 1;</code>
   */
  public int getPeopleStreamResponseCount() {
    return peopleStreamResponse_.size();
  }
  /**
   * <code>repeated .com.ilidan.grpc.PeopleStreamResponse peopleStreamResponse = 1;</code>
   */
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    for (int i = 0; i < peopleStreamResponse_.size(); i++) {
      output.writeMessage(1, peopleStreamResponse_.get(i));
    }
  ...
  public int getSerializedSize() {
    ...
    for (int i = 0; i < peopleStreamResponse_.size(); i++) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(1, peopleStreamResponse_.get(i));
    }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    result = result && getPeopleStreamResponseList()
        .equals(other.getPeopleStreamResponseList());
  ...
  public int hashCode() {
    ...
    if (getPeopleStreamResponseCount() > 0) {
      hash = (37 * hash) + PEOPLESTREAMRESPONSE_FIELD_NUMBER;
      hash = (53 * hash) + getPeopleStreamResponseList().hashCode();
    }
  ...
  public static final class Builder extends
    ...
    public Builder clear() {
      ...
      if (peopleStreamResponseBuilder_ == null) {
        ...
        peopleStreamResponseBuilder_.clear();
      }
      return this;
    }
    ...
    public com.ilidan.grpc.PeopleList buildPartial() {
      ...
      if (peopleStreamResponseBuilder_ == null) {
        ...
        result.peopleStreamResponse_ = peopleStreamResponse_;
      } else {
        result.peopleStreamResponse_ = peopleStreamResponseBuilder_.build();
      }
      onBuilt();
      return result;
    }
      ...
      if (peopleStreamResponseBuilder_ == null) {
        if (!other.peopleStreamResponse_.isEmpty()) {
          if (peopleStreamResponse_.isEmpty()) {
            peopleStreamResponse_ = other.peopleStreamResponse_;
            bitField0_ = (bitField0_ & ~0x00000001);
          } else {
            ensurePeopleStreamResponseIsMutable();
            peopleStreamResponse_.addAll(other.peopleStreamResponse_);
          }
          onChanged();
        }
      } else {
        if (!other.peopleStreamResponse_.isEmpty()) {
          if (peopleStreamResponseBuilder_.isEmpty()) {
            peopleStreamResponseBuilder_.dispose();
            peopleStreamResponseBuilder_ = null;
            peopleStreamResponse_ = other.peopleStreamResponse_;
            bitField0_ = (bitField0_ & ~0x00000001);
            peopleStreamResponseBuilder_ = 
              com.google.protobuf.GeneratedMessageV3.alwaysUseFieldBuilders ?
                 getPeopleStreamResponseFieldBuilder() : null;
          } else {
            peopleStreamResponseBuilder_.addAllMessages(other.peopleStreamResponse_);
          }
        }
      }
    ...
    public java.util.List<com.ilidan.grpc.PeopleStreamResponse> getPeopleStreamResponseList() {
      if (peopleStreamResponseBuilder_ == null) {
        ...
        return peopleStreamResponseBuilder_.getMessageList();
      }
    }
    /**
     * <code>repeated .com.ilidan.grpc.PeopleStreamResponse peopleStreamResponse = 1;</code>
    ...
    public int getPeopleStreamResponseCount() {
      if (peopleStreamResponseBuilder_ == null) {
        ...
        return peopleStreamResponseBuilder_.getCount();
      }
    }
    /**
     * <code>repeated .com.ilidan.grpc.PeopleStreamResponse peopleStreamResponse = 1;</code>
    ...
    public com.ilidan.grpc.PeopleStreamResponse getPeopleStreamResponse(int index) {
      if (peopleStreamResponseBuilder_ == null) {
        ...
        return peopleStreamResponseBuilder_.getMessage(index);
      }
    }
    /**
     * <code>repeated .com.ilidan.grpc.PeopleStreamResponse peopleStreamResponse = 1;</code>
    ...
    public Builder setPeopleStreamResponse(
      ...
      if (peopleStreamResponseBuilder_ == null) {
        ...
        ensurePeopleStreamResponseIsMutable();
        peopleStreamResponse_.set(index, value);
        onChanged();
      } else {
        peopleStreamResponseBuilder_.setMessage(index, value);
      }
      return this;
    }
    /**
    ...
    public Builder setPeopleStreamResponse(
      ...
      if (peopleStreamResponseBuilder_ == null) {
        ...
        peopleStreamResponseBuilder_.setMessage(index, builderForValue.build());
      }
      return this;
    }
    /**
    ...
    public Builder addPeopleStreamResponse(com.ilidan.grpc.PeopleStreamResponse value) {
      if (peopleStreamResponseBuilder_ == null) {
        ...
        ensurePeopleStreamResponseIsMutable();
        peopleStreamResponse_.add(value);
        onChanged();
      } else {
        peopleStreamResponseBuilder_.addMessage(value);
      }
      return this;
    }
    /**
    ...
    public Builder addPeopleStreamResponse(
      ...
      if (peopleStreamResponseBuilder_ == null) {
        ...
        ensurePeopleStreamResponseIsMutable();
        peopleStreamResponse_.add(index, value);
        onChanged();
      } else {
        peopleStreamResponseBuilder_.addMessage(index, value);
      }
      return this;
    }
    /**
    ...
    public Builder addPeopleStreamResponse(
      ...
      if (peopleStreamResponseBuilder_ == null) {
        ...
        peopleStreamResponseBuilder_.addMessage(builderForValue.build());
      }
      return this;
    }
    /**
    ...
    public Builder addPeopleStreamResponse(
      ...
      if (peopleStreamResponseBuilder_ == null) {
        ...
        peopleStreamResponseBuilder_.addMessage(index, builderForValue.build());
      }
      return this;
    }
    /**
    ...
    public Builder addAllPeopleStreamResponse(
      ...
      if (peopleStreamResponseBuilder_ == null) {
        ...
        com.google.protobuf.AbstractMessageLite.Builder.addAll(
            values, peopleStreamResponse_);
        onChanged();
      } else {
        peopleStreamResponseBuilder_.addAllMessages(values);
      }
      return this;
    }
    /**
     * <code>repeated .com.ilidan.grpc.PeopleStreamResponse peopleStreamResponse = 1;</code>
     */
    public Builder clearPeopleStreamResponse() {
      if (peopleStreamResponseBuilder_ == null) {
        peopleStreamResponse_ = java.util.Collections.emptyList();
        bitField0_ = (bitField0_ & ~0x00000001);
        onChanged();
     ...
     * <code>repeated .com.ilidan.grpc.PeopleStreamResponse peopleStreamResponse = 1;</code>
     */
    public Builder removePeopleStreamResponse(int index) {
      if (peopleStreamResponseBuilder_ == null) {
        ensurePeopleStreamResponseIsMutable();
        peopleStreamResponse_.remove(index);
        onChanged();
      } else {
        peopleStreamResponseBuilder_.remove(index);
      }
      return this;
    }
    /**
    ...
    public com.ilidan.grpc.PeopleStreamResponseOrBuilder getPeopleStreamResponseOrBuilder(
      ...
      if (peopleStreamResponseBuilder_ == null) {
        ...
        return peopleStreamResponseBuilder_.getMessageOrBuilder(index);
      }
    }
    /**
     * <code>repeated .com.ilidan.grpc.PeopleStreamResponse peopleStreamResponse = 1;</code>
    ...
    // @@protoc_insertion_point(builder_scope:com.ilidan.grpc.PeopleList)
  }
